...
<table style="border-collapse: collapse; width: 590px; margin: 0 auto; border: 0; background-color:#fff;">
    ...
    <tr>
        <td align="center" style="padding: 0 35px;">
            <p style="color: #19375f; margin-bottom: 0px; margin-top: 0; font-size: 15px; line-height: 140%; ont-family: sans-serif, Arial, Gadget;">
                Для авторизации на сайте используйте следующие данные:<br> Логин: {{ $account->email }}<br>
                Пароль: {{ $password }}
            </p>
        </td>
    </tr>
