                ...
                @foreach($users as $index => $user)
                    <tr class="vertical-middle">
                        ...
                        @elseif($user->load_video && $user->video != '')
                            <p><a data-content="{{{ '<iframe width="560" height="315" src="'.$user->video.'" frameborder="0" allowfullscreen></iframe>' }}}" data-html="true" data-original-title="Загруженное видео" data-placement="right" rel="popover" class="btn btn-link" href="javascript:void(0);"><i class="fa fa-arrow-down"></i> Смотреть видео</a></p>
                        @endif
                        </td>
                        <td>
                            <p>
